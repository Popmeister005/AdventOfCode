...
for pair in puzzleInput:
    ...
    if (numbers[0] >= numbers[2] and numbers[0] <= numbers[3]) or (numbers[1] >= numbers[2] and numbers[1] <= numbers[3]):
        containedpair+=1
        containedpairlist.append(numbers)
    elif (numbers[2] >= numbers[0] and numbers[2] <= numbers[1]) or (numbers[3] >= numbers[0] and numbers[3] <= numbers[1]):
        containedpair+=1
        containedpairlist.append(numbers)
